        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">AD_Forum /</span>광고 게시글 리스트</h4>
                    <div class="card" style="height:800px; overflow-y:scroll;">
                        <!-- Search -->
                        <div class="navbar-nav mb-3">
                            <div class="nav-item d-inline">
                                <a href="write_ad_forum.jsp" class="btn btn-outline-primary float-end shadow-none" style="margin-top:15px; margin-left:15px">글쓰기</a>
