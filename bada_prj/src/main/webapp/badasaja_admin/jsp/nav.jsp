    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-7">
            ...
            <ul class="navbar-nav ms-lg-auto">
            	<li class="nav-item">
            		<div class="nav-link" id="OperaterID"><i class="tf-icons navbar-icon bx bx-user"></i><!-- 관리자아이디노출 --><%= id %></div>
            	</li>
                <li class="nav-item">
                    <a class="nav-link" href="login.jsp"> Logout</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="loi"><i class="tf-icons navbar-icon bx bx-cog"></i> Logout</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0)"><i class="tf-icons navbar-icon bx bx-lock-open-alt"></i> Exit</a>
                </li>
            </ul>
        </div>
    </div>
