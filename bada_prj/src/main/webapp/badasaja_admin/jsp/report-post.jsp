	...
	function getSearchData(){
		...
		$.ajax({
			...
			success:function(jsonObj){
				...
				$("#tab > tbody").append("<tr><td class='cfrNum'>"+jsonObj.cfrNum+"</td><td>"+jsonObj.cID
						+"</td><td>"+jsonObj.cfrMain+"</td><td>"+jsonObj.rCategory+"</td><td>"+jsonObj.cfrDate
					...
					$("tbody tr").click(function(e) {
							...
							printFrMain(param)
							//window.location.href = "ad_forum_info.jsp?cfrNum=" + data;
						}) 
			},
