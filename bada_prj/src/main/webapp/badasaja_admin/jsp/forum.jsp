...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" info="유저 게시글 전체 조회 페이지"%>
				...
				.ajax({
					...
					success : function(jsonObj) {
						...
						if (jsonObj.resultData.length == 0) {
							$("#tab > tbody")
									.append(
											"<tr><td colspan='5'><strong>조회결과 없음</strong></td></tr>")
						}

						$.each(jsonObj.resultData, function(i, jsonObj) {
							$("#tab > tbody").append(
									"<tr><td class='cfNum'>" + jsonObj.cfNum
											+ "</td><td>" + jsonObj.topic
											+ "</td><td>" + jsonObj.local
											+ "</td><td>" + jsonObj.status
											+ "</td><td>" + jsonObj.category
											+ "</td><td>" + jsonObj.writeDate
											+ "</td><td>" + jsonObj.cID
											+ "</td></tr>")
						})
						$("tbody tr")
								.click(
										function(e) {
											...
											// 보류
											window.location.href = "forum_info.jsp?cfNum="
													+ data;
										})
					},
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">C_Forum /</span>게시글 전체 리스트
						</h4>
							...
							<div class="navbar-nav mb-3">
								<div class="nav-item d-inline">
									...
									<ul class="dropdown-menu">
										...
										<li class="status"><a class="dropdown-item"
											href="javascript:void(0);">거래중</a></li>
										<li class="status"><a class="dropdown-item"
											href="javascript:void(0);">거래약속</a></li>
										<li class="status"><a class="dropdown-item"
											href="javascript:void(0);">거래완료</a></li>
										<li class="status"><a class="dropdown-item"
									...
									<a href="javascript:void(0);" id="idSearch"
										...
										placeholder="작성자_ID검색" style="margin-top: 15px; width: 150px;" />
								</div>
							</div>
							<!-- /Search -->
