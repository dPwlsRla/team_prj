...
public class AdminForumDAO {
	...
	public String selectAdImg(String afNum) throws SQLException, NamingException {
		...
		try {
			...
			query.append("  	select img from ad_img").append(" 			where af_num = ?");
		...
		try {
			...
			if ((cID != null && !cID.equals("")) && (gu == null || gu.equals("")) && (pr == null || pr.equals(""))
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where c_id like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where gu_name like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where product like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where cf_status like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where c_id like ? and gu_name like  ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where c_id like ? and product like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic,write_date, cf_status ")
						.append("      from admin_c_forum").append("    where c_id like ? and cf_status like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum").append("    where gu_name like  ? and product like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						...
						.append("    where c_id like ? and gu_name like ? and  product like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum")
						.append("    where c_id like ? and gu_name like ? cf_status like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum")
						.append("    where and  gu_name like ? and product like ?  and cf_status like ?");
				...
				query.append(" select cf_num, c_id, gu_name, product, cf_topic, write_date, cf_status ")
						.append("      from admin_c_forum")
						.append("    where c_id like ? and  gu_name like ? and product like ? and cf_status like ?");
	...
	/* º¸·ù
	 * public CForumVO selectForum(String cfNum) throws SQLException,
	 * NamingException { CForumVO cfVO = null;
	 * 
	 ...
	 * 
	 * pstmt.setString(1, cfNum); rs = pstmt.executeQuery();
	 * 
	 * if (rs.next()) { cfVO = new CForumVO();
	 * cfVO.setCfTopic(rs.getString("cf_topic"));
	 * cfVO.setCfMain(rs.getString("cf_main")); cfVO.set
	 * 
	 * }
	 * 
